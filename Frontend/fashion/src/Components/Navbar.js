...
const Navbar = () => {
  ...
  return (
    <>
      {/* Fixed header container (brand title + navbar) */}
        ...
        <header className="navbar">
          ...
          <div className="navbar-left">
            ...
            <button
              ...
              onClick={() => handleCategoryClick("/mencollection")}
              type="button"
            >
              Men
            </button>
            ...
            <button
              className="gender-btn"
              onClick={() => handleCategoryClick("/womencollection")}
              type="button"
            >
              Women
            </button>
  ...
  <Link to="/profile" className="user-link" aria-label="Account">
    <i className="fas fa-user"></i>
  </Link>
) : (
  <Link to="/login" className="user-link" aria-label="Account">
    <i className="fas fa-user"></i>
  </Link>
)}

            <Link to="/cart" onClick={handleCartClick} className="cart-link" aria-label="Cart">
